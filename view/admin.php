  ...
  <body>
    ...
    <div class="row">
        ...
        <div class="col-md-8 shadow p-3 mb-5 bg-white rounded">
            <a href="" class="btn btn-primary mb-1">Tambah Users</a>
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $row['alasan'] ?></td>
                        <td>
                            <a href="../controller/ijinkan.php?id=<?= $row['id_cuti'] ?>" class="btn btn-warning">Edit</a>
                            <a href="../controller/tolak.php?id=<?= $row['id_cuti'] ?>" class="btn btn-danger">Hapus</a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
